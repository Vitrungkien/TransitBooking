...
//            redisService.setList("all-product", result, 20);
            return result;
        }
        catch (Exception e) {
...
//    List<UserDTO> getAdminInfor() {
//        try {
//            UserDTO cached = redisService.get("admin-infor", UserDTO.class);
//            if (cached != null) {
//                return cached;
//            }
//
...
//            List<ProductDTO> result = mapperService.toProductDTOList(productList);
//
//            redisService.setList("all-product", result, 60);
//            return result;
//        }
//        catch (Exception e) {
//            log.error("Lỗi lấy danh sách vé: {}", e.getMessage(), e);
